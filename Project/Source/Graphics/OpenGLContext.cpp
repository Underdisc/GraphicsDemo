...
/*!
\brief
  Initializes an OpenGL context within the SDL window created by the SDLContext
  class.
*/
/*****************************************************************************/
...
{
  SDL_GL_SwapWindow(SDLContext::SDLWindow());
}
...
{
  SDL_GL_GetDrawableSize(SDLContext::SDLWindow(), &_width, &_height);
